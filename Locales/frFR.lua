...
AtrL["Auction created for %s"] = "Vente créée pour %s" --in chat after auction created
AtrL["Auction cancelled for "] = "Vente annulée pour " --in chat after checking for undercuts and auction cenceled
